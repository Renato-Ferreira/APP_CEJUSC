...
const reclamacaoRotas = (app) =>{

    app.route('/reclamacao/agendar')
    ...
    .post( async (req, res) => {
        await insereParte(req.body.processo, req.body.sql);

        async function insereParte(processo, sqlInsert) {
